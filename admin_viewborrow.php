...
<!--Program Name: admin_viewborrow.php-->
<!--Description: this page allow admin view all borrow detail in the library system-->
...
<?php
  include('dbconnection.php');
    ...
    $sqlQuery ="SELECT * From borrow_table";
...
<div class="container">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    <h2>Admin View Borrow Page Page</h2>
                    <span class="underline center"></span>
                    <p class="lead">This page allow admin view all user's borrow record in library system</p>
                </div>
                <div class="breadcrumb">
                    <ul>
                        <li><a href="admin_homepage.php">Admin Home Page</a></li>
                        <li>Admin View Borrow Page</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <?php if (!empty($_SESSION["staffemail"])){?>
             ...
             <br><br/><br/><br/><?php echo '<h1>All Borrow Record (Admin)</h1>';?><br/><br/>
            <br/>
			<h2><font color="black">Click Borrow id to update</font></h2>
            <br/>
            <div id = "content1">
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                <td><a href="admin_editborrow.php?id=<?php echo $row['id']; ?>"><?php echo $row['id'];?> </td>
