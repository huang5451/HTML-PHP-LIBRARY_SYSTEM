...
<!--Program Name: admin_viewallbook.php-->
<!--Description: this page allow admin view all book detail in the library system-->
...
<div class="container">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    <h2>Admin View Book Page</h2>
                    <span class="underline center"></span>
                    <p class="lead">This page allow admin View all book in library system</p>
                </div>
                <div class="breadcrumb">
                    <ul>
                        <li><a href="admin_homepage.php">Admin Home Page</a></li>
                        <li>Admin View All Book Page</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <div id="innercontent">
            <br/>
            <h2><font color="black">All Book (Admin)</font></h2>
            <br/>
			<h2><font color="black">Click book id to update</font></h2>
            <br/>
            <div id = "content1">
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                <td><a href="admin_updatebook.php?id=<?php echo $row['id']; ?>"><?php echo $row['id'];?> </td>
