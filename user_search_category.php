...
<!--Description: this page allow user choose genre to search book in library system-->
...
$sqlQuery ="SELECT * FROM book_table WHERE genre_id = '$genres'";
...
<head>        
    ...
    <body class="body1">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">This page allow user choose genre to search this genre's books.</p>
                </div>
        ...
        <div id="content1">
            <div id="innercontent">
            <br>
            <h2> <font color="black">Genres Page</h2>
            <br/><br/><br/><br/>
            <section class="search-filters">
            <div class="container">
                <div class="filter-box">
                    <h3>What genre are you looking for at the library?</h3>
                    <div id="searchbtnn">
        <form action = "#" method='get'>
          
            <label for="genres">Genres</label>
                <select name="genres" >
                    <option value="">Choose Genre to search</option>
