...
<!--Program Name: admin_viewmoney.php-->
<!--Description: this page allow admin view all user's compensation detail in the library system-->
...
<?php
  include('dbconnection.php');
    ...
    $sqlQuery ="SELECT * From compensation_table";
...
<div class="container">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    <h2>Admin View User's Compensation Page</h2>
                    <span class="underline center"></span>
                    <p class="lead">This page allow admin view user's compensation record</p>
                </div>
                <div class="breadcrumb">
                    <ul>
                        <li><a href="admin_homepage.php">Admin Home Page</a></li>
                        <li>Admin check Compensation Page</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <?php if (!empty($_SESSION["staffemail"])){?>
             ...
             <br><br/><br/><br/><?php echo '<h1>All Compensation Record (Admin)</h1>';?><br/><br/>
            <br/>
