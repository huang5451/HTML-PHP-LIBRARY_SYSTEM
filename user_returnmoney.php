...
<!--Program Name: user_returnmoney.php-->
<!--Description: this page allow user see his compensation money in library system-->
...
$sqlQuery ="SELECT * From compensation_table WHERE email = '$id1' ";
...
<head>        
    ...
    <body class="body1">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    <h2>Compensation Page</h2>
                    <span class="underline center"></span>
                    <p class="lead">This page allow user pay compensation for a book.</p>
                </div>
        ...
        <div id="innercontent">
        <br/><br/>
        <h1><font color="black"> Compensation Page </font></h2>
            <br/>
            <br/>
        <div id = "content1">
        ...
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            ...
            <h2><font color="black">Your Email: <?php echo $row['email']; ?>   </font></h2> 
            
            <br/><br/>
            <h2><font color="orange">You Need Pay RM <?php echo $row['price']; ?>   </font></h2>
            <br/><br/>

        <?php }?>
            <h2><font color="black">Funds Transfer</font></h2>
            <br/><br/>
            <h2><font color="black">Bank Detail: MAYBANK</font></h2>
            <br/><br/>
            <h2><font color="black">Bank ACC: 172012939667</font></h2>
            <br/><br/>
            <h2><font color="black">After transfer send receipt to huang5451@gmail.com </font></h2>
            <br/><br/>
        </form>
    </div>
