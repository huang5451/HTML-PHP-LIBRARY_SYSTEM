...
<!--Program Name: user_search.php-->
<!--Description: this page allow user type book name to search book in library system-->
...
<?php
    ...
    $sqlQuery = "SELECT * FROM book_table WHERE `book name` = '$bookname'";
...
<head>        
    ...
    <body class="body1">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">This page allow user search what they want book</p>
                </div>
        ...
        <div id="content1">
            <div id="innercontent">
            <br>
            <h2> <font color="black">Search Page</h2>
            <br/><br/><br/><br/>
        ...
        <form action = "#" method='get'>
            Enter Book name: <input type="text" name="txtBookname">
