...
<!--Program Name: user_cart.php-->
<!--Description: this page allow user can use cart to borrow book or delete book in cart.-->
...
$sqlQuery ="SELECT * FROM cart_table WHERE email = '$id1'";
$result=mysqli_query($connection,$sqlQuery);


  
if (isset($_GET['btnBorrow'])){
$bookname=$_GET['txtBN'];
$bday='14 days';
$price=$_GET['txtPrice'];
    
$UpdateQuery = "INSERT INTO `borrow_table`( `email`, `book name`, `borrow days`, `status`, `price`) VALUES ('$id1','$bookname','$bday','$status','$price')";
...
$UpdateQuery = "DELETE FROM `cart_table` WHERE `email`='$id1'";
if(mysqli_query($connection, $UpdateQuery)){
        echo 'Successfully Borrow! ';
...
<head>        
    ...
    <header id="header-v1" class="navbar-wrapper">
        ...
        <div id="innercontent">
        <br/><br/>
        <h2><font color="black">Cart </font></h2>
            <br/>
			<h2><font color="black">Click borrow button to borrow</font></h2>
            <br/>
        <div id = "content1">
        ...
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            ...
            <tr>
                <td> <input type="text" name="txtBN" readonly="readonly" value="<?php echo $row['book name']; ?>"> </td>
                
                <td> <input type="text" name="txtPrice" readonly="readonly" value="<?php echo $row['price']; ?>">  </td>
                <td><input type="submit" value="Borrow" name="btnBorrow"></td>
            </tr>
        ...
        <input type="submit" value="Delete All Book" name="btnDelete">
        </form>
        </div>
