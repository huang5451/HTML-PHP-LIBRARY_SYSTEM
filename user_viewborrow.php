...
<!--Program Name: user_viewborrow.php-->
<!--Description: this page allow user view his borrow status in library system-->
...
$sqlQuery ="SELECT * From borrow_table WHERE email = '$id1' ";
$result=mysqli_query($connection,$sqlQuery);

if (isset($_POST['btnCompensation'])){
$price=$_POST["txtPrice"];
$UpdateQuery4 = "INSERT INTO `compensation_table`( `email`, `price`) VALUES ('$id1','$price')";
    if(mysqli_query($connection, $UpdateQuery4)){
        header('Location: user_returnmoney.php');
        }else{
...
<head>        
    ...
    <body class="body1">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    <h2>Your Borrow Status Page</h2>
                    <span class="underline center"></span>
                    <p class="lead">This page allow user view borrow status</p>
                </div>
        ...
        <div id="innercontent">
        <br/><br/>
        <h1><font color="black">Your Borrow Status </font></h2>
            <br/>
            <br/>
        <div id = "content1">
        ...
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td> <?php echo $row['borrow days']; ?>   </td>
                <td> <?php echo $row['status']; ?>   </td>
            </tr> 
        
        </table>
        <br/>
        <h3>if you want return book, you need return to library offline.</h2>
        <br/>

        <h3>if book is missing or something, you need pay RM <input type="text" value="<?php echo $row['price']; ?>" readonly="readonly" name="txtPrice">   </h3>
        <div id = "backbutton">
            <input type="submit" value="Compesation" name="btnCompensation">
        </div>
        <?php }?>
        </form>
    </div>
