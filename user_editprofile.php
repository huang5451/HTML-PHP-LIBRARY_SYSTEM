...
<!--Program Name: user_editprofile.php-->
<!--Description: this page allow user can edit his profile data in system.-->
...
if (isset($_POST['btnUpdate'])){
        ...
        $UpdateQuery = "UPDATE `user_table` SET `first name`='$fname',`last name`='$lname',`age`='$age',`gender`='$gender',`email`='$email',`password`='$password',`address`='$address',`phone no`='$phoneno' WHERE `email`='$id1'";
...
<header id="header-v1" class="navbar-wrapper">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">This page allow user press his email to edit his data.</p>
                </div>
        ...
        <div id="content1">
            ...
            <h1><font color="black"> Edit Profile</font></h1>
            <br><br>
            <?php
