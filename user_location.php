...
<!--Program Name: user_location.php-->
<!--Description: this page allow user can know our library system openning time and its location.-->
<!--First Written On: Thusday, 9-March-2023-->
<!--Edited On: Thusday, 9-March-2023-->
...
<head>        
        ...
        <!-- Title -->
        <title>High Performamce Library System</title>
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">This page provided our location address and some details to welcome user contact us.</p>
                </div>
                            ...
                            <div class="container">
                                <div class="contact-location">
                                    <div class="flipcard">
                                        <div class="front">
                                            ...
                                            <div class="bottom-info">
                                                ...
                                                <ul>
                                                    <li>121 King Street, Kuala Lumpur </li>
                                                    <li>Malaysia</li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flipcard">
                                        <div class="front">
                                            <div class="top-info">
                                                <span><i class="fa fa-fax" aria-hidden="true"></i> Openning Time</span>
                                            </div>
                                            <div class="bottom-info">
                                                <span class="top-arrow"></span>
                                                <ul>
                                                    <li>Tuesday - Sunday</a></li>
                                                    <li>8:00 AM- 11:00 PM</a></li>
                                                    <li>If closing will notice</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="back">
                                    ...
                                    <div class="flipcard">
                                        <div class="front">
                                            ...
                                            <div class="bottom-info">
                                                <span class="top-arrow"></span>
                                                <ul>
                                                    <li><a href="mailto:huang545@gmail.com">huang545@gmail.com</a></li>
                                                    <li><a href="mailto:support@HPLB.com">support@HPLB.com</a></li>
                                                    <li><a href="mailto:henr@gmail.com">henr@gmail.com</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="back">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="contact-form bg-light margin-right">
                                                            <h3>Location of High Performance Library System</h3>
                                                            <span class="underline left"></span>
                                                            <div class="contact-fields">
                                                                <form id="contact" name="contact" action="http://libraria.demo.presstigers.com/contact.html" method="post" >
                                                                    <div class="row">
                                                                     <p><font size="5">High Performance library system is mainly for WWU student and lecturer to easy to borrow book and read anytime, so location is nearby World Wide University. </font></p>
                                                                    </div>                                                                   
                                                            </div>
                                                        </div>
                                                    </div>
