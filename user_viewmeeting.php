...
<!--Program Name: user_viewmeeting.php-->
<!--Description: this page allow user view his meetting room of booking in library system-->
...
$query = "SELECT * FROM mr_table WHERE email = '$id1'";
