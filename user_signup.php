...
<style>
    ...
    <body class="body1">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">This is our system register page of User.</p>
                </div>
        ...
        <?php echo ' <h2><font color="black">Registration </font></h2>';?>
        <br>
        ...
        Phone No.:<br/>
        <input type="text" name="txtPhoneNo"/> <br/>
  ...
  $sqlQuery =" INSERT INTO `user_table`(`first name`,`last name`, `age`, `gender`,`email`, `password`, `address`, `phone no`) 
  VALUES ('$fname','$lname','$age','$gender','$email','$password','$address',$phoneno)";
