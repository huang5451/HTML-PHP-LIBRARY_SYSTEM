...
<!--Program Name: user_viewmprofile.php-->
<!--Description: this page allow user view his profile data in library system-->
<!--First Written On: Saturday, 11-March-2023-->
...
$query = "SELECT * FROM user_table WHERE email = '$id1'";
...
<head>        
    ...
    <body class="body1">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">This page allow user view his data of register in library system.</p>
                </div>
        ...
        <div id="content1">
            <div id="innercontent">
            <br>
            <h2> <font color="black">Your Profile</h2>
            <br>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <div id = "content3">
                    <div id="content4">
                      <h2><font color="blue">Press Email to edit profile</font></h2>
                      <br><br>
                      <h2><font color="black">First Name: <?php echo $row['first name']; ?></font></h2>
                      <br><br>
                      <h2><font color="black">Last Name: <?php echo $row['last name']; ?></font></h2>
                      <br><br>
                      <h2><font color="black">Age: <?php echo $row['age']; ?></font></h2>
                      <br><br>
                      <h2><font color="black">Gender: <?php echo $row['gender']; ?></font></h2>
                      <br><br>
                      <h2><font color="black">Email:</font><font color="orange"><a href="user_editprofile.php?id=<?php echo $row['email']; ?>"> <?php echo $row['email']; ?></a></font></h2>
                      <br><br>
                      <h2><font color="black">Password: <?php echo $row['password']; ?></font></h2>
                      <br><br>
                      <h2><font color="black">Address: <?php echo $row['address']; ?></font></h2>
                      <br><br>
                      <h2><font color="black">Phone No.: <?php echo $row['phone no']; ?></font></h2>
                      <br>
                    </div>
                </div>
            <?php } ?>
