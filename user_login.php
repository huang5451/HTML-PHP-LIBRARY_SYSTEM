...
<!--Program Name: user_login.php-->
<!--Description: this page allow user login his account in library system-->
...
<?php
        ...
        if (!empty($_SESSION["useremail"])){
	        echo '<br>Admin Name: ' . $_SESSION["useremail"];
        } else{
...
<head>        
    ...
    <body class="body1">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">This is our system's login page of user.</p>
                </div>
        ...
        <div id="content1">
            <div id="innercontent">
                <br/><br/><br/><br/>
                <h2><font color="black">Please Login to access Library System</font></h2>
                <br/><br/>
                <form method="post">
		        Email :<br/>
