...
<!--Program Name: user_scan.php-->
<!--Description: this page allow user type barcode isbn to search book in library system-->
...
if(isset($_GET['btnDisplay'])){
    $barcode = $_GET['txtIsbn'];

}

// step 2- create an sql command - SELECT, UPDATE, INSERT, DELETE
$sqlQuery = "SELECT * FROM book_table WHERE `isbn` = '$barcode'";
...
<head>        
    ...
    <body class="body1">
        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">This page allow user search what they want book with typing ISBN</p>
                </div>
        ...
        <div id="content1">
            <div id="innercontent">
            <br>
            <h2> <font color="black">Scan Page</h2>
            <br/><br/><br/><br/>
            <section class="search-filters">
            <div class="container">
                <div class="filter-box">
                    <h3>What are you looking for at the library?</h3>
                    <h3><font color="red"><a href="user_search_category.php">Choose Genres to search</a></font></h3>
                    <div id="searchbtnn">
        <form action = "#" method='get'>
            Enter ISBN to search: <input type="text" name="txtIsbn">
        ...
        <?php while($row = mysqli_fetch_assoc($result)) {?>
            <tr>
                <td> <font color="red"><a href="user_bookpage.php?id=<?php echo $row['id']; ?>"><?php echo $row['id'];?> </font></td>
                <td> <?php echo $row['book name']; ?></a>    </td>
